...
LoadSetting() {
    ...
    MySoftData.PauseHotkey := IniRead(IniFile, IniSection, "PauseHotkey", "F11")
    MySoftData.HoldPauseHotkey := IniRead(IniFile, IniSection, "HoldPauseHotkey", "Esc")
    MySoftData.PauseResumeDelay := IniRead(IniFile, IniSection, "PauseResumeDelay", 1)
    MySoftData.LockHotkey := IniRead(IniFile, IniSection, "LockHotkey", "F12")
...
OnSaveSetting(*) {
    ...
    IniWrite(MySoftData.HoldPauseHotkeyCtrl.Value, IniFile, IniSection, "HoldPauseHotkey")
    IniWrite(MySoftData.PauseResumeDelayCtrl.Value, IniFile, IniSection, "PauseResumeDelay")
    IniWrite(MySoftData.LockHotkeyCtrl.Value, IniFile, IniSection, "LockHotkey")
